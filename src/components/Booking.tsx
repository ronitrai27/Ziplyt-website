            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <motion.div 
                  ...
                  animate={stepsInView ? { scale: 1, opacity: 1 } : { scale: 0.8, opacity: 0 }}
                  transition={{
                    type: "spring",
                    stiffness: 100,
                    damping: 15,
                ...
                <motion.h3 
                  className="font-bold text-xl mb-2 text-deep"
                  initial={{ opacity: 0, x: -10 }}
                  animate={stepsInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -10 }}
                  transition={{
                    duration: 0.5,
                    delay: 0.4 + (index * 0.15)
                  }}
                >
                  {step.step}. {step.step === 1 ? "Choose" : step.step === 2 ? "Select" : "Confirm"} 
                  {step.step === 1 ? " Service" : step.step === 2 ? " Worker" : " Booking"}
                </motion.h3>
