...
const Feature = () => {
  ...
  const cardVariants = {
    ...
    hover: {
      y: -8,
      boxShadow:
        "0 20px 25px -5px rgba(0, 94, 255, 0.1), 0 10px 10px -5px rgba(0, 94, 255, 0.1)",
  ...
  return (
    <section
      ref={sectionRef}
      className="container py-4 px-4 min-[1000px]:mt-10"
      id="features"
    >
      <main>
        <motion.h4
              ...
              >
                ...
                >
                  {i === 0 && (
                    <ShieldCheck
                      size={18}
                      className="text-primary-blue min-[799px]:size-5"
                    />
                  )}
                  {i === 1 && (
                    <AlarmClock
