          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 min-[900px]:grid-cols-3 w-full mt-6 gap-10">
            ...
            <div className="flex flex-col items-center text-center px-4">
              ...
              <div className="flex gap-4 justify-center mt-5">
                <Link
                  href="https://www.instagram.com/ziplyt.official?utm_source=qr&igsh=emRmaXA4M2Z1bnV3"
                  target="_blank"
                ...
                <Link
                  href="https://www.linkedin.com/company/ziplyt/?viewAsMember=true"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Image
            ...
            <div className="px-4 flex flex-col items-center text-center">
              ...
              <ul className="text-lg text-gray-300 flex flex-col gap-3">
                <li className="flex flex-col sm:flex-row gap-1">
                  ...
                  <a href="mailto:hello@ziplyt.com" className="text-white">
                    hello@ziplyt.com
                  </a>
                </li>
                <li className="flex flex-col sm:flex-row gap-1">
